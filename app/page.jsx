  ...
  return (
    <div className="bg-slate-950 text-white font-sans overflow-x-hidden -m-6">
      ...
      <section className="relative min-h-[calc(100vh-65px)] flex flex-col justify-center px-6 py-16 overflow-hidden">
        ...
        {/* Clear Subtly Dimmed Backdrop Overlays — Makes Video Crisp & High Contrast */}
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 items-center gap-12 z-10">
          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            <div className="inline-flex items-center space-x-2 px-4 py-1.5 bg-slate-950/70 border border-indigo-500/40 rounded-full text-indigo-300 text-xs font-bold tracking-wide backdrop-blur-md">
            ...
            <p className="text-sm text-slate-200 max-w-lg mx-auto lg:mx-0 leading-relaxed bg-slate-950/75 p-4 rounded-xl border border-slate-800/80 backdrop-blur-md">
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-2">
              ...
              <Link
                href="#how-it-works"
                className="px-6 py-4 bg-slate-950/80 hover:bg-slate-900 text-slate-100 font-bold text-sm rounded-2xl border border-slate-700 hover:border-slate-600 backdrop-blur-md transition-all"
              >
            ...
            <div className="grid grid-cols-3 gap-3 pt-6 border-t border-slate-800/80 max-w-lg mx-auto lg:mx-0">
              <div className="bg-slate-950/70 p-3 rounded-xl border border-slate-800/60 backdrop-blur-md">
          ...
          <div className="w-full h-[400px] sm:h-[480px] rounded-3xl bg-slate-950/40 border border-slate-700/80 shadow-2xl relative overflow-hidden backdrop-blur-md">
